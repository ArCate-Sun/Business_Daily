...
layout.controller('MainCtrl', function($scope, $rootScope, $location, $layout, $layoutToggles, $pageLoadingBar) {
...
layout.factory('$layoutToggles', function($rootScope, $layout){
...
layout.factory('$pageLoadingBar', function($rootScope, $window){
...
layout.factory('$layout', function($rootScope, $cookies, $cookieStore){
