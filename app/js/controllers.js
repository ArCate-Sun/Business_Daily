...
angular.module('xenon.controllers', []).
	...
	controller('SidebarMenuCtrl', function($scope, $rootScope, $menuItems, $timeout, $http, $state, $location)
	{

		$http.get("data/business-daily/main-menu.json").then(function (response) {

			// Menu Items
			var $sidebarMenuItems = $menuItems.instantiate();

			$scope.menuItems = $sidebarMenuItems.prepareSidebarMenu(response.data).getAll();
	...
	controller("UserInfoCtrl", function ($scope, $http) {
		$http.get("data/business-daily/user-info.json").then(function (response) {
